/**
 * @fileoverview Development server for El Pollo Loco.
...
const startServer = async () => {
  try {
    ...
    app.listen(port, () => {
      console.log(`El Pollo Loco is running at http://localhost:${port}`);
      ...
      if (process.env.NODE_ENV !== "production") {
        console.log(`LiveReload running on port 35730`);
